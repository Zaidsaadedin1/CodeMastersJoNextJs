...
const MenuComponent = () => {
  ...
  const renderAuthMenu = () => (
    <Menu>
      ...
      <Menu.Dropdown>
        ...
        >
          <Group gap={2}>
            <IconDashboard size={14} color="white" />
      ...
      <Menu shadow="md" width={200}>
        <Menu.Target>
          <Button
            size="12"
            variant="subtle"
            style={{ direction: isRTL ? "rtl" : "ltr" }} color="white"
          >
            {t("account")}
          </Button>
        </Menu.Target>
  ...
  return (
    <Grid bg="#5c7caf" align="center" columns={3} p='xs' justify="space-between">
      <Image
        src="/images/logo-tp-yellow.png"
        alt="Logo"
        width={50}
        height={50}
        onClick={() => router.push("/")}
